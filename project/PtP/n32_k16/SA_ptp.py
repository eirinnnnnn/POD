...
def target_block(run_dir: str = ".", seed: int = None, P_IDX: int = -2):
    ...
    for restart in range(5):
        ...
        param_init = [
        '11111111111111111111111111111111110011111111000011101111111111111000111101111111',
        [12, 25, 3, 24, 18, 16, 29, 1, 27, 30, 4, 15, 21, 23, 26, 22, 28, 9, 19, 8, 2, 0, 13, 17, 11, 14, 20, 31, 5, 7, 10, 6]
        ]
