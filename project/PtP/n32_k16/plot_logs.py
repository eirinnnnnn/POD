...
# Cycling pools for unrecognised (UNKNOWN) entries.
UNKNOWN_COLOR_POOL = [
    "tab:blue", "tab:orange", "tab:green", "tab:red",
    "tab:purple", "tab:brown", "tab:pink", "tab:gray",
    "tab:olive", "tab:cyan",
]
UNKNOWN_MARKER_POOL = ["o", "s", "^", "D", "v", "P", "X", "*"]
UNKNOWN_LINESTYLE_POOL = ["-", "--", "-.", ":", (0, (3, 1, 1, 1))]
...
def main() -> None:
    ...
    unknown_colors     = itertools.cycle(UNKNOWN_COLOR_POOL)
    unknown_markers    = itertools.cycle(UNKNOWN_MARKER_POOL)
    unknown_linestyles = itertools.cycle(UNKNOWN_LINESTYLE_POOL)
    ...
    for folder_str in args.folders:
        ...
        if st["family"] == "UNKNOWN":
            st["color"]     = next(unknown_colors)
            st["marker"]    = next(unknown_markers)
            st["linestyle"] = next(unknown_linestyles)
