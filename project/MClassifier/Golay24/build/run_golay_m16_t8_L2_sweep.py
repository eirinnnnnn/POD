#!/usr/bin/env python3
"""Golay24 static-pm-rank sweep: M=16 automorphism ensemble, list_size=2,
checkpoint t=8 used to rank branches for pruning, final metric used for
selection among the pruned survivors. Original 8-point SNR grid,
m in {1,2,3,4,8}."""
import csv
import subprocess
...
SAMPLE_CAP = {2.00: 8_000, 2.25: 12_000, 2.50: 20_000, 2.75: 35_000,
              3.00: 60_000, 3.50: 130_000, 4.00: 300_000, 4.50: 600_000}
TARGET_ERRORS = 1000
CHECKPOINT = 8
M_LIST = [1, 2, 3, 4, 8]
RESUME_EVERY = 20_000

RESULTS = OUTDIR / "golay_m16_t8_L2_results.txt"
...
def seed_pair(snr_idx):
    return 740001 + snr_idx, 640001 + snr_idx
...
def main():
    ...
    for i, snr in enumerate(SNR_LIST):
        ...
        cap = SAMPLE_CAP[snr]
        cs, ms = seed_pair(i)
        log = OUTDIR / f"golay_m16_t8_L2_snr{t_tag}.log"
